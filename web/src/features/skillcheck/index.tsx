...
const useStyles = createStyles((theme, params: { difficultyOffset: number }) => ({
  svg: {
    ...
    width: 500,
    height: 500,
    filter: 'drop-shadow(0 0 15px rgba(255, 255, 255, 0.7))', // Glow effect for the entire SVG
  },
  track: {
    fill: 'transparent',
    stroke: 'rgba(0, 0, 0, 0.5)', // Semi-transparent dark stroke for the track
    strokeWidth: 14,
    r: 50,
    cx: 250,
    cy: 250,
  ...
  skillArea: {
    fill: 'transparent',
    stroke: 'url(#gradient)', // Use gradient stroke for the skill area
    strokeWidth: 14,
    r: 50,
    cx: 250,
    cy: 250,
    ...
    filter: 'drop-shadow(0 0 10px rgba(255, 255, 255, 0.7))', // Glow effect for the skill area
    '@media (min-height: 1440px)': {
      strokeWidth: 18,
      r: 65,
      strokeDasharray: 2 * 65 * Math.PI,
  ...
  indicator: {
    stroke: 'url(#indicator-gradient)', // Gradient for the indicator
    strokeWidth: 16,
    fill: 'transparent',
    r: 50,
    cx: 250,
    ...
    filter: 'drop-shadow(0 0 10px rgba(255, 0, 0, 0.7))', // Glow effect for the indicator
    '@media (min-height: 1440px)': {
      strokeWidth: 18,
      r: 65,
      strokeDasharray: 2 * 65 * Math.PI,
  ...
  button: {
    ...
    alignItems: 'center',
    color: '#ffffff',
    textShadow: '0 0 10px rgba(255, 255, 255, 0.7)', // Glow effect for the text
    '@media (min-height: 1440px)': {
      width: 40,
      height: 40,
      fontSize: 24,
        ...
        <>
          <svg className={classes.svg}>
            <defs>
              ...
              <linearGradient id="indicator-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: '#ff0000', stopOpacity: 1 }} />
